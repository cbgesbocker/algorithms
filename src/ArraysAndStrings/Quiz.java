...
////
////        new Quiz().rotate(matrix, 2);
////        new Quiz().isSubstring("conner rconne");
//    }
//
//
...
//     *
//     */
//    public boolean isRotation(String str, String t) {
//        int len = str.length();
//        if (len == t.length() && len > 0) {
//            /* concatenate str and str with new buffer */
//            String s1 = str + str;
//            return isSubstring(s1s1, t);
//        }
//        return false;
//
//    }
